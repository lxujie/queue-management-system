...
<script setup lang="ts">
  ...
  /**
  * Logs a console message when the "Join Queue" button is clicked.
  ...
  */
  ...
  /**
  * Handles form submission for joining the queue.
  * - Validates phone number format (Singapore only).
  * - Checks Firestore to ensure phone number isn't already in the queue.
  * - Adds new entry to the 'queue' collection in Firestore with 'waiting' status.
  * - Optionally sends a Twilio SMS notification using a Netlify function.
  * - Displays success or error messages and resets form state.
  */
  ...
  /**
  * Sets up a real-time Firestore listener to track how many users
  * are currently in the queue with status "waiting", and updates
